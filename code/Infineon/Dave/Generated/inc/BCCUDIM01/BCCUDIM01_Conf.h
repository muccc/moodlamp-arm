...
/*CODE_BLOCK_BEGIN[BCCUDIM01_Conf.h]*/
/****************************************************************************
 * @file     BCCUDIM01_Conf.h
 * @brief    Configuration header file generated based on UI settings 
 *           of BCCUDIM01 App. It contains all Constants generated by UI configs.
 * @version  V1.0.8
 * @date     12-Nov-13
 *
 * @note
...
#ifndef _CONF_BCCUDIM01_H_
#define _CONF_BCCUDIM01_H_

#ifdef __cplusplus
extern "C" {
#endif
/**
 * @ingroup BCCUDIM01_constants
 * @{
 */


#define BCCUDIM01_NUM_INSTANCES (1U)
