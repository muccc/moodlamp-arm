...
const BCCUGlobal_HandleType BCCUGlobal_Handle0 =
{
    .BCCURegs = BCCU0,

    .FastClk_PS = (uint16_t)80,

    .BitClk_Div = BCCU_FCLK_DIV_4,

    .DimClk_PS = (uint16_t)219,

    .TriggerMode = BCCUGLOBAL_TRIGMODE_0,

    .TriggerDelay = BCCUGLOBAL_NO_DELAY,

	.OutMaxZeroTime = (uint16_t)200,

	.TrapEdge = BCCUGLOBAL_RISING_EDGE,

	.GlobalDimInitialLevel = (uint16_t)0,
